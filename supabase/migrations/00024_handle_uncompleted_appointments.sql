-- =============================================================================
-- Migration 00024: Handle Uncompleted Appointments
-- =============================================================================
-- If a user accidentally marks an appointment as "completed", the system
-- generates the financial transactions. If they then change it back to
-- "scheduled" or "cancelled", we need to remove the generated transactions
-- so they don't get duplicated if it gets completed again later.
-- =============================================================================
